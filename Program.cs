...

{
    ...
    class Calculator
    {
         ...
         void Root()
        {
            ...
            {   //Nth root, n>=2
                 Console.WriteLine(" !! The second number must be a integer that more than 1  ! Enter other number again!");
                 number2 = GetNumberFromUser("second");
             } 
         ...
         void Exponet()
        {
            ...
            {   //they can't be 0---exponetion
                  Console.WriteLine(" The second number must be not 0 when number2 is 0! Enter other number again!");
                    number2 = GetNumberFromUser("first");
            } 
